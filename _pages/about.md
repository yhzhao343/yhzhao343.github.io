...
During my summer interships, I am student researcher at the Google perception - audio accessibility team working on the [audio-to-tactile](https://github.com/google/audio-to-tactile) project where we aim to "enable users with hearing loss to 'feel' sound and understand speech through vibrotactile interfaces". I work on the device prototyping and the interface implementation.
